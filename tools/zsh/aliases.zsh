...
alias drrx11='docker run --rm -i -t --network host -u $(id -u):$(id -g) -v /etc/passwd:/etc/passwd:ro -v /etc/group:/etc/group:ro -v $PWD:/w -w /w -v $HOME/.Xauthority:$HOME/.Xauthority:ro -e DISPLAY'
alias e='echo'
alias g='git'

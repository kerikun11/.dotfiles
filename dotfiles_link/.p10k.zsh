# Generated by Powerlevel10k configuration wizard on 2020-06-29 at 22:44 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=27
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=70
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%165F'  # purple foreground

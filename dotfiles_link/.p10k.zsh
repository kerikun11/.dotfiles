# Generated by Powerlevel10k configuration wizard on 2020-06-29 at 23:24 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 09924.
# Wizard options: compatible, unicode, lean_8colors, 24h time, 2 lines, dotted,
# no frame, white-ornaments, compact, concise, instant_prompt=verbose.
